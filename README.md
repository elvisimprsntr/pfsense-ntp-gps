...
4. The Garmin 19x HVS has bare leads and requires unregulated 8-33 Vdc, so in theory you should be able to power it from the same power supply as the Mini PC. Although the specs indicate it can be connected a serial port, I have not specifically tested this model.  
